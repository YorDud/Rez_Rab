...
{
	public partial class Proyavlen_Photorez_ProvMod_Admin : Form
	{
		public Proyavlen_Photorez_ProvMod_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Proyavlen_Photorez_ProvMod_Admin_Load(object sender, EventArgs e)
		{
