...
using Rez_Lab.Proyavlen_Photorez_ProvMod;


namespace Rez_Lab
{
    public partial class Start_Proyavlen_Photorez_admin : Form
    {

        
        public Start_Proyavlen_Photorez_admin()
        {
            InitializeComponent();
        ...
        public Start_Proyavlen_Photorez_admin(Avtorize aavtorize)
        {
            InitializeComponent();
        ...
        private void Start_Proyavlen_Photorez_admin_Load(object sender, EventArgs e)
        {
		...
		{
			this.Hide();
			Proyavlen_Photorez_Ult1_Admin TM2A = new Proyavlen_Photorez_Ult1_Admin();
			TM2A.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Proyavlen_Photorez_Ult2_Admin poa = new Proyavlen_Photorez_Ult2_Admin();
			poa.ShowDialog();
			this.Show();
		...
		{
			this.Hide();
			Proyavlen_Photorez_ProvMod_Admin poa = new Proyavlen_Photorez_ProvMod_Admin();
			poa.ShowDialog();
			this.Show();
		}
