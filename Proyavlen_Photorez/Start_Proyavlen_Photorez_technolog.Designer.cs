namespace Rez_Lab
{
    partial class Start_Proyavlen_Photorez_technolog
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Start_Proyavlen_Photorez_technolog));
			...
			this.button4.Text = "Ультрафильтрация 3";
			...
			this.button5.Text = "Ультрафильтрация 4";
			...
			// 
			// Start_Proyavlen_Photorez_technolog
			// 
			...
			this.Name = "Start_Proyavlen_Photorez_technolog";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Лаборатория Резонит";
			this.Load += new System.EventHandler(this.Start_Proyavlen_Photorez_technolog_Load);
