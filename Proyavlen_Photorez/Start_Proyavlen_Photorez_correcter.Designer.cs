namespace Rez_Lab
{
    partial class Start_Proyavlen_Photorez_correcter
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Start_Proyavlen_Photorez_correcter));
			...
			// 
			// Start_Proyavlen_Photorez_correcter
			// 
			...
			this.Name = "Start_Proyavlen_Photorez_correcter";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Лаборатория Резонит";
			this.Load += new System.EventHandler(this.Start_Proyavlen_Photorez_correcter_Load);
