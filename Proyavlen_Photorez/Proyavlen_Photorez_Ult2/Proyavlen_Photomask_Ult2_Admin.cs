...
{
	public partial class Proyavlen_Photorez_Ult2_Admin : Form
	{
		public Proyavlen_Photorez_Ult2_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Proyavlen_Photorez_Ult2_Admin_Load(object sender, EventArgs e)
		{
