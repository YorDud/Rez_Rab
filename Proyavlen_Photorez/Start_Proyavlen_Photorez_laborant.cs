...
namespace Rez_Lab
{
    public partial class Start_Proyavlen_Photorez_laborant : Form
    {
        public Start_Proyavlen_Photorez_laborant()
        {
            InitializeComponent();
		...
		{
			this.Hide();
			Proyavlen_Photorez_ProvMod_Laborant tmc = new Proyavlen_Photorez_ProvMod_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Proyavlen_Photorez_Ult1_Laborant tmc = new Proyavlen_Photorez_Ult1_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Proyavlen_Photorez_Ult2_Laborant tmc = new Proyavlen_Photorez_Ult2_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
