...
namespace Rez_Lab
{
	public partial class Start_Proyavlen_Photorez_correcter : Form
	{
		...
		public Start_Proyavlen_Photorez_correcter()
		{
			InitializeComponent();
			//TimerForButton();
			timer = new Timer();
		...
		private void Start_Proyavlen_Photorez_correcter_Load(object sender, EventArgs e)
		{
...
//		}
		...
		{
			this.Hide();
			Proyavlen_Photorez_ProvMod_Corrector tmc = new Proyavlen_Photorez_ProvMod_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Proyavlen_Photorez_Ult1_Corrector tmc = new Proyavlen_Photorez_Ult1_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Proyavlen_Photorez_Ult2_Corrector tmc = new Proyavlen_Photorez_Ult2_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		private DataSet GetAllDataFromDatabase()
		{
            ...
            WHERE 
                ...
                AND (
                    ...
                    OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR ([Pro_Photorez_2_Correction_Score] IS NOT NULL AND [Pro_Photorez_2_Correction_Score] <> '')
                );
            ...
            WHERE 
                ...
                AND (
                    ...
                    OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR ([Pro_Photorez_3_Correction_Score] IS NOT NULL AND [Pro_Photorez_3_Correction_Score] <> '')
                );
        ";
