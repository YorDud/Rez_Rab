...
{
	public partial class Proyavlen_Photorez_Ult1_Admin : Form
	{
		public Proyavlen_Photorez_Ult1_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Proyavlen_Photorez_Ult1_Admin_Load(object sender, EventArgs e)
		{
