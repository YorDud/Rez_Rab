...
{
	public partial class Proyavlen_Photorez_Ult1_Technolog : Form
	{
		public Proyavlen_Photorez_Ult1_Technolog()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Proyavlen_Photorez_Ult1_Technolog_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				string updateQuery = @"
        UPDATE Proyavlen_Photorez_Ult1 SET
            [Date_tech] = @Date_tech,
