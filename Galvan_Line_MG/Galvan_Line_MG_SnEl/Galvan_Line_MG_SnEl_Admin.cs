...
namespace Rez_Lab.Galvan_Line_MG_SnEl
{
	public partial class Galvan_Line_MG_SnEl_Admin : Form
	{
		public Galvan_Line_MG_SnEl_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Line_MG_SnEl_Admin_Load(object sender, EventArgs e)
		{
