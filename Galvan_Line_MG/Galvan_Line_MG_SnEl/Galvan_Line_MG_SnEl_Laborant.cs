...
{
	public partial class Galvan_Line_MG_SnEl_Laborant : Form
	{
		public Galvan_Line_MG_SnEl_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Line_MG_SnEl_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
...
[Gal_Line_6_SnSO4] = @Gal_Line_6_SnSO4
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Gal_Line_6_H2SO4" && column.Name != "Gal_Line_6_SnSO4")
				{
