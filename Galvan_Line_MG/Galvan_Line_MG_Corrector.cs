...
{
	public partial class Galvan_Line_MG_Corrector : Form
	{
		public Galvan_Line_MG_Corrector()
		{
			InitializeComponent();
...
HighlightEmptyCells(dataGridView1, columnsToCheck);
		...
		private void Galvan_Line_MG_Corrector_Load(object sender, EventArgs e)
		{
			LoadData();
