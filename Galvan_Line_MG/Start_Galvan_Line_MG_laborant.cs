...
namespace Rez_Lab
{
    public partial class Start_Galvan_Line_MG_Cleaner_laborant : Form
    {
		...
		public Start_Galvan_Line_MG_Cleaner_laborant()
        {
            InitializeComponent();
		...
		{
			this.Hide();
			Galvan_Line_MG_KisOch_Laborant tmc = new Galvan_Line_MG_KisOch_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_MG_Microtrav_Laborant tmc = new Galvan_Line_MG_Microtrav_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_MG_Cu_Laborant tmc = new Galvan_Line_MG_Cu_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_MG_Sn_Laborant tmc = new Galvan_Line_MG_Sn_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_MG_CuEl1819_Laborant tmc = new Galvan_Line_MG_CuEl1819_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_MG_CuEl2021_Laborant tmc = new Galvan_Line_MG_CuEl2021_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_MG_SnEl_Laborant tmc = new Galvan_Line_MG_SnEl_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Trav_Podv_Laborant poa = new Trav_Podv_Laborant();
			poa.ShowDialog();
			this.Show();
		}
