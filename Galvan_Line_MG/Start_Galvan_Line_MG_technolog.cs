...
namespace Rez_Lab
{
    public partial class Start_Galvan_Line_MG_Cleaner_technolog : Form
    {
		private Timer timer;
		...
		public Start_Galvan_Line_MG_Cleaner_technolog()
        {
            InitializeComponent();
        ...
        private void Start_Galvan_Line_MG_Cleaner_technolog_Load(object sender, EventArgs e)
        {
            label1.Text = WC.fio;
...
//		}
		...
		{
			this.Hide();
			Galvan_Line_MG_KisOch_Technolog tmd = new Galvan_Line_MG_KisOch_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_MG_Microtrav_Technolog tmd = new Galvan_Line_MG_Microtrav_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_MG_Cu_Technolog tmd = new Galvan_Line_MG_Cu_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_MG_Sn_Technolog tmd = new Galvan_Line_MG_Sn_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_MG_CuEl1819_Technolog tmd = new Galvan_Line_MG_CuEl1819_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_MG_CuEl2021_Technolog tmd = new Galvan_Line_MG_CuEl2021_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_MG_SnEl_Technolog tmd = new Galvan_Line_MG_SnEl_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
