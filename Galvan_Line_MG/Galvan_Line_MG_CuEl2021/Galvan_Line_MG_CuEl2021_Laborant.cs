...
{
	public partial class Galvan_Line_MG_CuEl2021_Laborant : Form
	{
		public Galvan_Line_MG_CuEl2021_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Line_MG_CuEl2021_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
   ...
   SET [Gal_Line_5_H2SO4] = @Gal_Line_5_H2SO4,
...
[Gal_Line_5_CuSO4] = @Gal_Line_5_CuSO4
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Gal_Line_5_H2SO4" && column.Name != "Gal_Line_5_NaCl" && column.Name != "Gal_Line_5_PM624A" && column.Name != "Gal_Line_5_PM624b" && column.Name != "Gal_Line_5_CuSO4")
				{
...
[Gal_Line_5_CuSO4] = @Gal_Line_5_CuSO4
	...
	WHERE ID = @ID";
		...
		private void HighlightEmptyCells(DataGridView dataGridView, int[] columns)
		{
			...
			try
			{
				correctionMatColumnIndex = dataGridView.Columns["Gal_Line_5_Correction_Mat"].Index;
			}
		...
		private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			if (e.RowIndex >= 0 && columnsToCheck.Contains(e.ColumnIndex))
			{
				...
				var correctionMatValue = selectedRow.Cells["Gal_Line_5_Correction_Mat"].Value;
