...
{
	public partial class Galvan_Line_MG_Sn_Laborant : Form
	{
		public Galvan_Line_MG_Sn_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Line_MG_Sn_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
