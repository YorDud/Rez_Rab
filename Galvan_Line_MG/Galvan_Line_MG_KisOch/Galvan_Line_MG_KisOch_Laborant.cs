...
{
	public partial class Galvan_Line_MG_KisOch_Laborant : Form
	{
		public Galvan_Line_MG_KisOch_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Line_MG_KisOch_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
