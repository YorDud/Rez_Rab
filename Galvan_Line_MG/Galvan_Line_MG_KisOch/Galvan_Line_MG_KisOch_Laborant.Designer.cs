...
{
	partial class Galvan_Line_MG_KisOch_Laborant
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Galvan_Line_MG_KisOch_Laborant));
			...
			// 
			// Galvan_Line_MG_KisOch_Laborant
			// 
			...
			this.Name = "Galvan_Line_MG_KisOch_Laborant";
			this.Text = "Лаборатория Резонит";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.Galvan_Line_MG_KisOch_Laborant_Load);
