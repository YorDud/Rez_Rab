...
namespace Rez_Lab.Galvan_Line_MG_KisOch
{
	public partial class Galvan_Line_MG_KisOch_Admin : Form
	{
		public Galvan_Line_MG_KisOch_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Line_MG_KisOch_Admin_Load(object sender, EventArgs e)
		{
