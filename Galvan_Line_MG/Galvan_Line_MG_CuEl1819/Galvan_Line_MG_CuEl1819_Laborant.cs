...
{
	public partial class Galvan_Line_MG_CuEl1819_Laborant : Form
	{
		public Galvan_Line_MG_CuEl1819_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Line_MG_CuEl1819_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
   ...
   SET [Gal_Line_4_H2SO4] = @Gal_Line_4_H2SO4,
...
[Gal_Line_4_CuSO4] = @Gal_Line_4_CuSO4
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Gal_Line_4_H2SO4" && column.Name != "Gal_Line_4_NaCl" && column.Name != "Gal_Line_4_PM624A" && column.Name != "Gal_Line_4_PM624b" && column.Name != "Gal_Line_4_CuSO4")
				{
...
[Gal_Line_4_CuSO4] = @Gal_Line_4_CuSO4
	...
	WHERE ID = @ID";
		...
		private void HighlightEmptyCells(DataGridView dataGridView, int[] columns)
		{
			...
			try
			{
				correctionMatColumnIndex = dataGridView.Columns["Gal_Line_4_Correction_Mat"].Index;
			}
		...
		private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			if (e.RowIndex >= 0 && columnsToCheck.Contains(e.ColumnIndex))
			{
				...
				var correctionMatValue = selectedRow.Cells["Gal_Line_4_Correction_Mat"].Value;
