...
namespace Rez_Lab
{
    public partial class Start_Pryam_Metal_laborant : Form
    {
        public Start_Pryam_Metal_laborant()
        {
            InitializeComponent();
		...
		{
			this.Hide();
			Pryam_Metal_Cond_Laborant tmc = new Pryam_Metal_Cond_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Pryam_Metal_PredMet_Laborant tmc = new Pryam_Metal_PredMet_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Pryam_Metal_Met_Laborant tmc = new Pryam_Metal_Met_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Pryam_Metal_Uskor_Laborant tmc = new Pryam_Metal_Uskor_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Pryam_Metal_PredMet303_Laborant tmc = new Pryam_Metal_PredMet303_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
