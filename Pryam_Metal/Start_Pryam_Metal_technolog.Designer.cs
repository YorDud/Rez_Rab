namespace Rez_Lab
{
    partial class Start_Pryam_Metal_technolog
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Start_Pryam_Metal_technolog));
			...
			this.label5.TextChanged += new System.EventHandler(this.label5_TextChanged_1);
			// 
			// button6
			// 
			...
			this.Name = "Start_Pryam_Metal_technolog";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Лаборатория Резонит";
			this.Load += new System.EventHandler(this.Start_Pryam_Metal_technolog_Load);
