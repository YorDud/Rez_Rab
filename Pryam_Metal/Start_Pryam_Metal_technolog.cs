...
namespace Rez_Lab
{
    public partial class Start_Pryam_Metal_technolog : Form
    {
		private Timer timer;
		...
		public Start_Pryam_Metal_technolog()
        {
            InitializeComponent();
        ...
        private void Start_Pryam_Metal_technolog_Load(object sender, EventArgs e)
        {
            label1.Text = WC.fio;
...
//		}
		...
		{
			this.Hide();
			Pryam_Metal_Cond_Technolog tmd = new Pryam_Metal_Cond_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Pryam_Metal_PredMet_Technolog tmd = new Pryam_Metal_PredMet_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Pryam_Metal_Met_Technolog tmd = new Pryam_Metal_Met_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Pryam_Metal_Uskor_Technolog tmd = new Pryam_Metal_Uskor_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
...
WHERE ([FIO_tech] IS NULL OR [FIO_tech] = '') 
   OR ([Date_tech] IS NULL OR [Date_tech] = '');";
		...
		private void label5_TextChanged_1(object sender, EventArgs e)
		{
			if (int.TryParse(label5.Text, out int labelValue) && labelValue > 0)
			{
				StartBlinking2();
...
WHERE ([FIO_tech] IS NULL OR [FIO_tech] = '') 
   OR ([Date_tech] IS NULL OR [Date_tech] = '');";
		...
		{
			this.Hide();
			Pryam_Metal_PredMet303_Technolog tmd = new Pryam_Metal_PredMet303_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
