...
namespace Rez_Lab.Pryam_Metal_Uskor
{
	public partial class Pryam_Metal_Uskor_Admin : Form
	{
		public Pryam_Metal_Uskor_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Pryam_Metal_Uskor_Admin_Load(object sender, EventArgs e)
		{
