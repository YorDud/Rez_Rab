...
{
	public partial class Pryam_Metal_Uskor_Technolog : Form
	{
		public Pryam_Metal_Uskor_Technolog()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Pr_Met_4_Correction_Mat"].DefaultCellStyle.BackColor = Color.PeachPuff;
				dataGridView1.Columns["Pr_Met_4_Correction_Score"].DefaultCellStyle.BackColor = Color.PeachPuff;
		...
		private void Pryam_Metal_Uskor_Technolog_Load(object sender, EventArgs e)
		{
			LoadData();
