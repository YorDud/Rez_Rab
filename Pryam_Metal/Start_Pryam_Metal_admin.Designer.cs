namespace Rez_Lab
{
    partial class Start_Pryam_Metal_admin
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Start_Pryam_Metal_admin));
			...
			this.button3.Text = "Предметализация 2 ПМ 303";
			...
			this.Name = "Start_Pryam_Metal_admin";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Лаборатория Резонит";
			this.Load += new System.EventHandler(this.Start_Pryam_Metal_admin_Load);
