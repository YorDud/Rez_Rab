...
{
	public partial class Pryam_Metal_PredMet_Admin : Form
	{
		public Pryam_Metal_PredMet_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Pryam_Metal_PredMet_Admin_Load(object sender, EventArgs e)
		{
