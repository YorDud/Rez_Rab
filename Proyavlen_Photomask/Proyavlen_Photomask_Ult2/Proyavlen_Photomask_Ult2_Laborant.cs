...
{
	public partial class Proyavlen_Photomask_Ult2_Laborant : Form
	{
		public Proyavlen_Photomask_Ult2_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Proyavlen_Photomask_Ult2_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
...
[Pro_Photomask_3_A_B] = @Pro_Photomask_3_A_B
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Pro_Photomask_3_CO32" && column.Name != "Pro_Photomask_3_CO3" && column.Name != "Pro_Photomask_3_pH" && column.Name != "Pro_Photomask_3_A_B")
				{
