...
{
	public partial class Proyavlen_Photomask_Ult2_Admin : Form
	{
		public Proyavlen_Photomask_Ult2_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Proyavlen_Photomask_Ult2_Admin_Load(object sender, EventArgs e)
		{
