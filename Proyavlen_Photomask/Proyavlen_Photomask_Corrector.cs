...
{
	public partial class Proyavlen_Photomask_Corrector : Form
	{
		public Proyavlen_Photomask_Corrector()
		{
			InitializeComponent();
		}
...
HighlightEmptyCells(dataGridView1, columnsToCheck);
		...
		private void Proyavlen_Photomask_Corrector_Load(object sender, EventArgs e)
		{
			LoadData();
