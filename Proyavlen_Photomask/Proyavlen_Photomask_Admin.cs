...
{
	public partial class Proyavlen_Photomask_Admin : Form
	{
		public Proyavlen_Photomask_Admin()
		{
			InitializeComponent();
		}
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Proyavlen_Photomask_Admin_Load(object sender, EventArgs e)
		{
		...
		private void Add_Row()
		{
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				string sqlInsert = "INSERT INTO Proyavlen_Photomask ([Date_Create]) " +
								   "VALUES (@Date_Create)";
		...
		private void dataGridView1_CellEndEdit_1(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Pro_Photomask_1_Correction = dataGridView1.Rows[e.RowIndex].Cells["Pro_Photomask_1_Correction"].Value;
				...
				var Pro_Photomask_2_Correction = dataGridView1.Rows[e.RowIndex].Cells["Pro_Photomask_2_Correction"].Value;
				...
				var Pro_Photomask_3_Correction = dataGridView1.Rows[e.RowIndex].Cells["Pro_Photomask_3_Correction"].Value;
...
var Сomment = dataGridView1.Rows[e.RowIndex].Cells["Сomment"].Value;
   ...
   SET [Date_Create] = @Date_Create
      ,[FIO_Lab] = @FIO_Lab
      ,[Pro_Photomask_1_CO32] = @Pro_Photomask_1_CO32,
...
[Pro_Photomask_1_Correction] = @Pro_Photomask_1_Correction,
...
[Pro_Photomask_2_Correction] = @Pro_Photomask_2_Correction,
...
[Pro_Photomask_3_Correction] = @Pro_Photomask_3_Correction
      ,[FIO_tech] = @FIO_tech
,[Date_tech] = @Date_tech
...
,[Сomment] = @Сomment
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					command.Parameters.AddWithValue("@Pro_Photomask_1_Correction", Pro_Photomask_1_Correction);
					...
					command.Parameters.AddWithValue("@Pro_Photomask_2_Correction", Pro_Photomask_2_Correction);
					...
					command.Parameters.AddWithValue("@Pro_Photomask_3_Correction", Pro_Photomask_3_Correction);
