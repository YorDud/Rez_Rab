namespace Rez_Lab
{
    partial class Start_Proyavlen_Photomask_admin
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Start_Proyavlen_Photomask_admin));
			...
			// 
			// Start_Proyavlen_Photomask_admin
			// 
			...
			this.Name = "Start_Proyavlen_Photomask_admin";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Лаборатория Резонит";
			this.Load += new System.EventHandler(this.Start_Proyavlen_Photomask_admin_Load);
