...
{
	public partial class Proyavlen_Photomask_Ult1_Laborant : Form
	{
		public Proyavlen_Photomask_Ult1_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Proyavlen_Photomask_Ult1_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
...
[Pro_Photomask_2_A_B] = @Pro_Photomask_2_A_B
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Pro_Photomask_2_CO32" && column.Name != "Pro_Photomask_2_CO3" && column.Name != "Pro_Photomask_2_pH" && column.Name != "Pro_Photomask_2_A_B")
				{
