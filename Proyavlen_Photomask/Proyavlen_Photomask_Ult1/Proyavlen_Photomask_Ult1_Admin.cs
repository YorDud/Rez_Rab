...
{
	public partial class Proyavlen_Photomask_Ult1_Admin : Form
	{
		public Proyavlen_Photomask_Ult1_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Proyavlen_Photomask_Ult1_Admin_Load(object sender, EventArgs e)
		{
