...
{
	partial class Proyavlen_Photomask_Corrector
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Proyavlen_Photomask_Corrector));
			...
			this.label13.Text = "Проявление Фотомаски";
			...
			this.Name = "Proyavlen_Photomask_Corrector";
			this.Text = "Лаборатория Резонит";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.Proyavlen_Photomask_Corrector_Load);
