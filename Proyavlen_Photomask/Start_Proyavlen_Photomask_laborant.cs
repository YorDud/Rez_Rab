...
namespace Rez_Lab
{
    public partial class Start_Proyavlen_Photomask_laborant : Form
    {
        public Start_Proyavlen_Photomask_laborant()
        {
            InitializeComponent();
		...
		{
			this.Hide();
			Proyavlen_Photomask_ProvMod_Laborant tmc = new Proyavlen_Photomask_ProvMod_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Proyavlen_Photomask_Ult1_Laborant tmc = new Proyavlen_Photomask_Ult1_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Proyavlen_Photomask_Ult2_Laborant tmc = new Proyavlen_Photomask_Ult2_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
