...
namespace Rez_Lab
{
	public partial class Start_Proyavlen_Photomask_correcter : Form
	{
		...
		public Start_Proyavlen_Photomask_correcter()
		{
			InitializeComponent();
			//TimerForButton();
			timer = new Timer();
		...
		private void Start_Proyavlen_Photomask_correcter_Load(object sender, EventArgs e)
		{
...
//		}
		...
		{
			this.Hide();
			Proyavlen_Photomask_ProvMod_Corrector tmc = new Proyavlen_Photomask_ProvMod_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Proyavlen_Photomask_Ult1_Corrector tmc = new Proyavlen_Photomask_Ult1_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Proyavlen_Photomask_Ult2_Corrector tmc = new Proyavlen_Photomask_Ult2_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		private void Load_Processes()
		{
			//Load_Process1();
			//Cleaner();
			Load_Proyavlen_Photomask_ProvMod();
			Load_Proyavlen_Photomask_Ult1();
			Load_Proyavlen_Photomask_Ult2();
		...
		private void Load_Proyavlen_Photomask_ProvMod()
		{
			string query = @"
         SELECT COUNT(*) 
...
AND (
    ...
    ([Pro_Photorez_1_Correction_Score] IS NOT NULL AND [Pro_Photorez_1_Correction_Score] <> ''));";
		...
		private void Load_Proyavlen_Photomask_Ult1()
		{
			string query = @"
         SELECT COUNT(*) 
...
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Pro_Photomask_2_Correction_Mat] IS NOT NULL AND [Pro_Photomask_2_Correction_Mat] <> '') OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Pro_Photomask_2_Correction_Score] IS NOT NULL AND [Pro_Photomask_2_Correction_Score] <> ''));";
		...
		private void Load_Proyavlen_Photomask_Ult2()
		{
			string query = @"
         SELECT COUNT(*) 
...
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Pro_Photomask_3_Correction_Mat] IS NOT NULL AND [Pro_Photomask_3_Correction_Mat] <> '') OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Pro_Photomask_3_Correction_Score] IS NOT NULL AND [Pro_Photomask_3_Correction_Score] <> ''));";
		...
		private DataSet GetAllDataFromDatabase()
		{
			...
			string query = @"
            SELECT 
                [Pro_Photorez_1_Correction_Mat],
                [Pro_Photorez_1_Correction_Score],
                [Сomment]
            FROM 
            ...
            WHERE 
                ...
                AND (
                    ...
                    OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR ([Pro_Photorez_1_Correction_Score] IS NOT NULL AND [Pro_Photorez_1_Correction_Score] <> '')
                );

            SELECT 
                [Pro_Photomask_2_Correction_Mat],
                [Pro_Photomask_2_Correction_Score],
                [Сomment]
            FROM 
            ...
            WHERE 
                ...
                AND (
                    ...
                    OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR ([Pro_Photomask_2_Correction_Score] IS NOT NULL AND [Pro_Photomask_2_Correction_Score] <> '')
                );

            SELECT 
                [Pro_Photomask_3_Correction_Mat],
                [Pro_Photomask_3_Correction_Score],
                [Сomment]
            FROM 
            ...
            WHERE 
                ...
                AND (
                    ...
                    OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR ([Pro_Photomask_3_Correction_Score] IS NOT NULL AND [Pro_Photomask_3_Correction_Score] <> '')
                );
        ";
		...
		private void PrintDocument_PrintPage(object sender, PrintPageEventArgs e)
		{
			...
			string title = "Проявление Фотомаски";
