...
namespace Rez_Lab
{
    public partial class Start_Proyavlen_Photomask_technolog : Form
    {
		private Timer timer;
		...
		public Start_Proyavlen_Photomask_technolog()
        {
            InitializeComponent();
        ...
        private void Start_Proyavlen_Photomask_technolog_Load(object sender, EventArgs e)
        {
            label1.Text = WC.fio;
...
//		}
		...
		{
			this.Hide();
			Proyavlen_Photomask_ProvMod_Technolog tmd = new Proyavlen_Photomask_ProvMod_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Proyavlen_Photomask_Ult1_Technolog tmd = new Proyavlen_Photomask_Ult1_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Proyavlen_Photomask_Ult2_Technolog tmd = new Proyavlen_Photomask_Ult2_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
