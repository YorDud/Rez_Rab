...
{
	partial class Proyavlen_Photomask_ProvMod_Laborant
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Proyavlen_Photomask_ProvMod_Laborant));
			...
			this.pictureBox2.Location = new System.Drawing.Point(1032, 76);
			...
			// 
			// Proyavlen_Photomask_ProvMod_Laborant
			// 
			...
			this.Name = "Proyavlen_Photomask_ProvMod_Laborant";
			this.Text = "Лаборатория Резонит";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.Proyavlen_Photomask_ProvMod_Laborant_Load);
