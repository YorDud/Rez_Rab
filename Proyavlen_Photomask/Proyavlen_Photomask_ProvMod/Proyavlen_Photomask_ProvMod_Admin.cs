...
namespace Rez_Lab.Proyavlen_Photomask_ProvMod
{
	public partial class Proyavlen_Photomask_ProvMod_Admin : Form
	{
		public Proyavlen_Photomask_ProvMod_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Proyavlen_Photomask_ProvMod_Admin_Load(object sender, EventArgs e)
		{
