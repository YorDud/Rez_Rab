...
{
	public partial class Proyavlen_Photomask_ProvMod_Laborant : Form
	{
		public Proyavlen_Photomask_ProvMod_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Proyavlen_Photomask_ProvMod_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
