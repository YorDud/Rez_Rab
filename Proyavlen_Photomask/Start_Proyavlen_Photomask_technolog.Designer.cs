namespace Rez_Lab
{
    partial class Start_Proyavlen_Photomask_technolog
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Start_Proyavlen_Photomask_technolog));
			...
			this.label13.Text = "Проявление ЗПМ";
			...
			this.button4.Text = "Ультрафильтрация 1";
			...
			this.button5.Text = "Ультрафильтрация 2";
			...
			// 
			// Start_Proyavlen_Photomask_technolog
			// 
			...
			this.Name = "Start_Proyavlen_Photomask_technolog";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Лаборатория Резонит";
			this.Load += new System.EventHandler(this.Start_Proyavlen_Photomask_technolog_Load);
