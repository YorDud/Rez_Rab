...
namespace Rez_Lab
{
    public partial class Start_Amm_Prom_technolog : Form
    {
		private Timer timer;
		...
		public Start_Amm_Prom_technolog()
        {
            InitializeComponent();
        ...
        private void Start_Amm_Prom_technolog_Load(object sender, EventArgs e)
        {
            label1.Text = WC.fio;
...
//		}
		...
		{
			this.Hide();
			Amm_Prom_Technolog tmd = new Amm_Prom_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
