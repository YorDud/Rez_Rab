...
namespace Rez_Lab
{
    public partial class Start_Amm_Prom_admin : Form
    {

        
        public Start_Amm_Prom_admin()
        {
            InitializeComponent();
        ...
        public Start_Amm_Prom_admin(Avtorize aavtorize)
        {
            InitializeComponent();
        ...
        private void Start_Amm_Prom_admin_Load(object sender, EventArgs e)
        {
		...
		{
			this.Hide();
			Amm_Prom_Admin TM2A = new Amm_Prom_Admin();
			TM2A.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Trav_Med_1_Admin poa = new Trav_Med_1_Admin();
			poa.ShowDialog();
			this.Show();
		}
