...
namespace Rez_Lab
{
    public partial class Start_Amm_Prom_laborant : Form
    {
        public Start_Amm_Prom_laborant()
        {
            InitializeComponent();
		...
		{
			this.Hide();
			Trav_Med_1_Laborant tmc = new Trav_Med_1_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Amm_Prom_Laborant tmc = new Amm_Prom_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
