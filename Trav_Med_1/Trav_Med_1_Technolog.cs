...
{
	public partial class Trav_Med_1_Technolog : Form
	{
		public Trav_Med_1_Technolog()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Trav_Med_1_Technolog_Load(object sender, EventArgs e)
		{
			LoadData();
