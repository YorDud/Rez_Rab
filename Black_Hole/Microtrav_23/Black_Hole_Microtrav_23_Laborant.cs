...
{
	public partial class Black_Hole_Microtrav_23_Laborant : Form
	{
		public Black_Hole_Microtrav_23_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Black_Hole_Microtrav_23_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
...
[Black_Hole_4_podtrav] = @Black_Hole_4_podtrav
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Black_Hole_4_Na2S2O3" && column.Name != "Black_Hole_4_Н2SO4" && column.Name != "Black_Hole_4_Cu2" && column.Name != "Black_Hole_4_podtrav")
				{
		...
		private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			else if (e.RowIndex >= 0 && e.ColumnIndex == 6) // Проверяем, что ячейка выбрана
			{
				...
				using (Form inputForm = new Form())
				{
					...
					inputForm.MinimizeBox = false;
					inputForm.StartPosition = FormStartPosition.CenterParent;
					inputForm.Text = "Подтравитель";

					Label labelValue1 = new Label()
					{
						Text = "Подтравитель = (m1 - m2) * 5,6",
						Top = 10,
						Left = 30,
						Width = 330
					};
