...
{
	public partial class Black_Hole_BAK1_Laborant : Form
	{
		public Black_Hole_BAK1_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Black_Hole_BAK1_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
   ...
   SET [Black_Hole_7_Na2S2O3] = @Black_Hole_7_Na2S2O3,
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Black_Hole_7_Na2S2O3")
				{
