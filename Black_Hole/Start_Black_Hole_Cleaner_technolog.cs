...
namespace Rez_Lab
{
    public partial class Start_Black_Hole_Cleaner_technolog : Form
    {
		private Timer timer;
		...
		public Start_Black_Hole_Cleaner_technolog()
        {
            InitializeComponent();
        ...
        private void Start_Black_Hole_Cleaner_technolog_Load(object sender, EventArgs e)
        {
            label1.Text = WC.fio;
...
WHERE ([FIO_tech] IS NULL OR [FIO_tech] = '') 
   OR ([Date_tech] IS NULL OR [Date_tech] = '');";
		...
		{
			this.Hide();
			Black_Hole_BAK1012_Technolog tmd = new Black_Hole_BAK1012_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Black_Hole_BAK1022_Technolog tmd = new Black_Hole_BAK1022_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
