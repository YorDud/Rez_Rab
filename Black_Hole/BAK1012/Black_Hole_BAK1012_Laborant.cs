...
{
	public partial class Black_Hole_BAK1012_Laborant : Form
	{
		public Black_Hole_BAK1012_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Black_Hole_BAK1012_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
