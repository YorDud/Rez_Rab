...
{
	public partial class Black_Hole_Admin : Form
	{
		public Black_Hole_Admin()
		{
			InitializeComponent();
		...
		private void LoadData()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				dataGridView1.Columns["Black_Hole_3_shelochnost"].HeaderText = "Щелочность";
				dataGridView1.Columns["Black_Hole_3_pH"].HeaderText = "pH";
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Black_Hole_Admin_Load(object sender, EventArgs e)
		{
		...
		private void Add_Row()
		{
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				string sqlInsert = "INSERT INTO Black_Hole ([Date_Create]) " +
								   "VALUES (@Date_Create)";
		...
		private void dataGridView1_CellEndEdit_1(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Black_Hole_3_shelochnost = dataGridView1.Rows[e.RowIndex].Cells["Black_Hole_3_shelochnost"].Value;
				var Black_Hole_3_pH = dataGridView1.Rows[e.RowIndex].Cells["Black_Hole_3_pH"].Value;
...
[Black_Hole_3_shelochnost] = @Black_Hole_3_shelochnost,
[Black_Hole_3_pH] = @Black_Hole_3_pH,
...
,[Сomment] = @Сomment
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					command.Parameters.AddWithValue("@Black_Hole_3_shelochnost", Black_Hole_3_shelochnost);
					command.Parameters.AddWithValue("@Black_Hole_3_pH", Black_Hole_3_pH);
