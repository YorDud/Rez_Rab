...
namespace Rez_Lab
{
	public partial class Start_Black_Hole_Cleaner_correcter : Form
	{
		...
		public Start_Black_Hole_Cleaner_correcter()
		{
			InitializeComponent();
			//TimerForButton();
			timer = new Timer();
		...
		private void Start_Black_Hole_Cleaner_correcter_Load(object sender, EventArgs e)
		{
...
//		}
		...
		private void Black_Hole_Cleaner()
		{
			string query = @"
        SELECT COUNT(*) 
...
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Black_Hole_1_Correction_Mat] IS NOT NULL AND [Black_Hole_1_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
...
";
		...
		private void Black_Hole_Conditioner()
		{
			string query = @"
         SELECT COUNT(*) 
...
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Black_Hole_2_Correction_Mat] IS NOT NULL AND [Black_Hole_2_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Black_Hole_2_Correction_Score] IS NOT NULL AND [Black_Hole_2_Correction_Score] <> ''));";
		...
		private void Black_Hole_Microtrav_1()
		{
			string query = @"
         SELECT COUNT(*) 
...
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Black_Hole_3_Correction_Mat] IS NOT NULL AND [Black_Hole_3_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Black_Hole_3_Correction_Score] IS NOT NULL AND [Black_Hole_3_Correction_Score] <> ''));";
		...
		private void Black_Hole_Microtrav_23()
		{
			string query = @"
         SELECT COUNT(*) 
...
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Black_Hole_4_Correction_Mat] IS NOT NULL AND [Black_Hole_4_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
...
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Black_Hole_5_Correction_Mat] IS NOT NULL AND [Black_Hole_5_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
...
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Black_Hole_6_Correction_Mat] IS NOT NULL AND [Black_Hole_6_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
...
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Black_Hole_7_Correction_Mat] IS NOT NULL AND [Black_Hole_7_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
...
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Black_Hole_8_Correction_Mat] IS NOT NULL AND [Black_Hole_8_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Black_Hole_8_Correction_Score] IS NOT NULL AND [Black_Hole_8_Correction_Score] <> ''));";
		...
		"!!! Conditioner !!!",
		"!!! Микротравление 1 !!!",
		"!!! Микротравление 2 и 3 !!!",
		"!!! Black Hole BHC- 1032 (ванна 1) !!!",
		"!!! Black Hole BHC- 1032 (ванна 2) !!!",
		"!!! БАК микротравление 1 !!!",
		"!!! БАК микротравление 2 !!!",
		"!!! БАК BHC- 1012 !!!",
		"!!! БАК BHC- 1022 !!!"
		};
		...
		private DataSet GetAllDataFromDatabase()
		{
			...
			string query = @"
            SELECT 
                [Black_Hole_1_Correction_Mat],
                [Black_Hole_1_Correction_Score],
                [Сomment]
            FROM 
                Black_Hole_Cleaner
            WHERE 
                ...
                AND (
                    ([Black_Hole_1_Correction_Mat] IS NOT NULL AND [Black_Hole_1_Correction_Mat] <> '') OR ([Сomment] IS NOT NULL AND [Сomment] <> '') 
                    OR ([Black_Hole_1_Correction_Score] IS NOT NULL AND [Black_Hole_1_Correction_Score] <> '')
                );

            SELECT 
                [Black_Hole_2_Correction_Mat],
                [Black_Hole_2_Correction_Score],
                [Сomment]
            FROM 
                Black_Hole_Conditioner
            WHERE 
                ([Сompleted] IS NULL OR [Сompleted] = '') 
                AND (
                    ([Black_Hole_2_Correction_Mat] IS NOT NULL AND [Black_Hole_2_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '')
                    OR ([Black_Hole_2_Correction_Score] IS NOT NULL AND [Black_Hole_2_Correction_Score] <> '')
                );

            SELECT 
                [Black_Hole_3_Correction_Mat],
                [Black_Hole_3_Correction_Score],
                [Сomment]
            FROM 
                Black_Hole_Microtrav_1
            WHERE 
                ([Сompleted] IS NULL OR [Сompleted] = '') 
                AND (
                    ([Black_Hole_3_Correction_Mat] IS NOT NULL AND [Black_Hole_3_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '')
                    OR ([Black_Hole_3_Correction_Score] IS NOT NULL AND [Black_Hole_3_Correction_Score] <> '')
                );

SELECT 
                [Black_Hole_4_Correction_Mat],
                [Black_Hole_4_Correction_Score],
                [Сomment]
            FROM 
                Black_Hole_Microtrav_23
            WHERE 
                ([Сompleted] IS NULL OR [Сompleted] = '') 
                AND (
                    ([Black_Hole_4_Correction_Mat] IS NOT NULL AND [Black_Hole_4_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '')
                    OR ([Black_Hole_4_Correction_Score] IS NOT NULL AND [Black_Hole_4_Correction_Score] <> '')
                );

SELECT 
                [Black_Hole_5_Correction_Mat],
                [Black_Hole_5_Correction_Score],
                [Сomment]
            FROM 
                Black_Hole_BHC1
            WHERE 
                ([Сompleted] IS NULL OR [Сompleted] = '') 
                AND (
                    ([Black_Hole_5_Correction_Mat] IS NOT NULL AND [Black_Hole_5_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '')
                    OR ([Black_Hole_5_Correction_Score] IS NOT NULL AND [Black_Hole_5_Correction_Score] <> '')
                );

SELECT 
                [Black_Hole_6_Correction_Mat],
                [Black_Hole_6_Correction_Score],
                [Сomment]
            FROM 
                Black_Hole_BHC2
            WHERE 
                ([Сompleted] IS NULL OR [Сompleted] = '') 
                AND (
                    ([Black_Hole_6_Correction_Mat] IS NOT NULL AND [Black_Hole_6_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '')
                    OR ([Black_Hole_6_Correction_Score] IS NOT NULL AND [Black_Hole_6_Correction_Score] <> '')
                );

SELECT 
                [Black_Hole_7_Correction_Mat],
                [Black_Hole_7_Correction_Score],
                [Сomment]
            FROM 
                Black_Hole_BAK1
            WHERE 
                ([Сompleted] IS NULL OR [Сompleted] = '') 
                AND (
                    ([Black_Hole_7_Correction_Mat] IS NOT NULL AND [Black_Hole_7_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '')
                    OR ([Black_Hole_7_Correction_Score] IS NOT NULL AND [Black_Hole_7_Correction_Score] <> '')
                );

SELECT 
                [Black_Hole_8_Correction_Mat],
                [Black_Hole_8_Correction_Score],
                [Сomment]
            FROM 
                Black_Hole_BAK2
            WHERE 
                ([Сompleted] IS NULL OR [Сompleted] = '') 
                AND (
                    ([Black_Hole_8_Correction_Mat] IS NOT NULL AND [Black_Hole_8_Correction_Mat] <> '')  OR ([Сomment] IS NOT NULL AND [Сomment] <> '')
...
SELECT 
		...
		{
			this.Hide();
			Black_Hole_BAK1012_Corrector tmc = new Black_Hole_BAK1012_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Black_Hole_BAK1022_Corrector tmc = new Black_Hole_BAK1022_Corrector();
			tmc.ShowDialog();
			this.Show();
		}

		private void Black_Hole_BAK1012()
		{
			string query = @"
        SELECT COUNT(*) 
...
";
		...
		private void Black_Hole_BAK1022()
		{
			string query = @"
        SELECT COUNT(*) 
