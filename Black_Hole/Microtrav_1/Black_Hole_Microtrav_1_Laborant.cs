...
{
	public partial class Black_Hole_Microtrav_1_Laborant : Form
	{
		public Black_Hole_Microtrav_1_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Black_Hole_Microtrav_1_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
...
[Black_Hole_3_Cu2] = @Black_Hole_3_Cu2
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Black_Hole_3_Na2S2O3" && column.Name != "Black_Hole_3_Н2SO4" && column.Name != "Black_Hole_3_Cu2")
				{
