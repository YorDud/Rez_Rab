...
{
	public partial class Black_Hole_Conditioner_Admin : Form
	{
		public Black_Hole_Conditioner_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Black_Hole_Conditioner_Admin_Load(object sender, EventArgs e)
		{
