...
{
	public partial class Black_Hole_Conditioner_Laborant : Form
	{
		public Black_Hole_Conditioner_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Black_Hole_Conditioner_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
   ...
   SET [Black_Hole_2_shelochnost] = @Black_Hole_2_shelochnost,
[Black_Hole_2_pH] = @Black_Hole_2_pH
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Black_Hole_2_shelochnost" && column.Name != "Black_Hole_2_pH")
				{
