...
{
	public partial class Black_Hole_BHC1_Laborant : Form
	{
		public Black_Hole_BHC1_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Black_Hole_BHC1_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
...
[Black_Hole_5_pH] = @Black_Hole_5_pH
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Black_Hole_5_soder_tv_chast" && column.Name != "Black_Hole_5_pH")
				{
		...
		private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
		{
			if (e.RowIndex >= 0 && e.ColumnIndex == 3) // Проверяем, что ячейка выбрана
			{
				...
				using (Form inputForm = new Form())
				{
					...
					{
						Text = "A - масса пустого тигля, г\r\nБ - масса тигиля с пробой до термообработки, г\r\nВ - масса тигиля с пробой после термообработки, г",
						Top = 40,
						Left = 10,
						Width = 330,
						Height = 100
