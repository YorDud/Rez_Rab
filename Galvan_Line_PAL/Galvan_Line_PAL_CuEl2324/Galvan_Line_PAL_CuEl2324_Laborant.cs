...
{
	public partial class Galvan_Line_PAL_CuEl2324_Laborant : Form
	{
		public Galvan_Line_PAL_CuEl2324_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Gal_Line_6_NaCl"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Gal_Line_6_CuSO4"].DefaultCellStyle.BackColor = Color.LightBlue;
		...
		private void Galvan_Line_PAL_CuEl2324_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void UpdateRow()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Gal_Line_6_NaCl = dataGridView1.Rows[rowIndex].Cells["Gal_Line_6_NaCl"].Value;
				var Gal_Line_6_CuSO4 = dataGridView1.Rows[rowIndex].Cells["Gal_Line_6_CuSO4"].Value;
   ...
   SET [Gal_Line_6_H2SO4] = @Gal_Line_6_H2SO4, 
...
[Gal_Line_6_CuSO4] = @Gal_Line_6_CuSO4
	...
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					command.Parameters.AddWithValue("@Gal_Line_6_NaCl", Gal_Line_6_NaCl);
					command.Parameters.AddWithValue("@Gal_Line_6_CuSO4", Gal_Line_6_CuSO4);
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Gal_Line_6_H2SO4" && column.Name != "Gal_Line_6_NaCl" && column.Name != "Gal_Line_6_CuSO4")
				{
		...
		private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Gal_Line_6_NaCl = dataGridView1.Rows[e.RowIndex].Cells["Gal_Line_6_NaCl"].Value;
				var Gal_Line_6_CuSO4 = dataGridView1.Rows[e.RowIndex].Cells["Gal_Line_6_CuSO4"].Value;
...
[Gal_Line_6_CuSO4] = @Gal_Line_6_CuSO4
	...
	WHERE ID = @ID";
		...
		private void HighlightEmptyCells(DataGridView dataGridView, int[] columns)
		{
			...
			try
			{
				correctionMatColumnIndex = dataGridView.Columns["Gal_Line_6_Correction_Mat"].Index;
			}
			catch (ArgumentException)
			{
				throw new ArgumentException("Столбец 'Gal_Line_4_Correction_Mat' не найден в DataGridView.");
			}
		...
		private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			if (e.RowIndex >= 0 && columnsToCheck.Contains(e.ColumnIndex))
			{
				...
				var correctionMatValue = selectedRow.Cells["Gal_Line_6_Correction_Mat"].Value;
