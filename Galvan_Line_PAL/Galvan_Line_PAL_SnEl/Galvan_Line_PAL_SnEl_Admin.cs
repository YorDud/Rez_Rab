...
namespace Rez_Lab.Galvan_Line_PAL_SnEl
{
	public partial class Galvan_Line_PAL_SnEl_Admin : Form
	{
		public Galvan_Line_PAL_SnEl_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Line_PAL_SnEl_Admin_Load(object sender, EventArgs e)
		{
		...
		private void dataGridView1_CellEndEdit_1(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var FIO_Lab = dataGridView1.Rows[e.RowIndex].Cells["FIO_Lab"].Value; // Название столбца FIO_Lab
																					 //
				var Gal_Line_7_H2SO4 = dataGridView1.Rows[e.RowIndex].Cells["Gal_Line_7_H2SO4"].Value;
...
,[Сomment] = @Сomment
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					//
					command.Parameters.AddWithValue("@Gal_Line_7_H2SO4", Gal_Line_7_H2SO4);
