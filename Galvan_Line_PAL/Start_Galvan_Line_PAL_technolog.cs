...
namespace Rez_Lab
{
    public partial class Start_Galvan_Line_PAL_Cleaner_technolog : Form
    {
		private Timer timer;
		...
		public Start_Galvan_Line_PAL_Cleaner_technolog()
        {
            InitializeComponent();
        ...
        private void Start_Galvan_Line_PAL_Cleaner_technolog_Load(object sender, EventArgs e)
        {
            label1.Text = WC.fio;
...
//		}
		...
		{
			this.Hide();
			Galvan_Line_PAL_KisOch_Technolog tmd = new Galvan_Line_PAL_KisOch_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_PAL_Microtrav_Technolog tmd = new Galvan_Line_PAL_Microtrav_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_PAL_Cu_Technolog tmd = new Galvan_Line_PAL_Cu_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_PAL_Sn_Technolog tmd = new Galvan_Line_PAL_Sn_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_PAL_CuEl1920_Technolog tmd = new Galvan_Line_PAL_CuEl1920_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_PAL_CuEl2122_Technolog tmd = new Galvan_Line_PAL_CuEl2122_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_PAL_CuEl2324_Technolog tmd = new Galvan_Line_PAL_CuEl2324_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Line_PAL_SnEl_Technolog tmd = new Galvan_Line_PAL_SnEl_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
...
WHERE ([FIO_tech] IS NULL OR [FIO_tech] = '') 
   OR ([Date_tech] IS NULL OR [Date_tech] = '');";
		...
		{
			this.Hide();
			Trav_Podv_PAL_Technolog tmd = new Trav_Podv_PAL_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
...
WHERE ([FIO_tech] IS NULL OR [FIO_tech] = '') 
   OR ([Date_tech] IS NULL OR [Date_tech] = '');";
		...
		private void InitializeTimer8()
		{
			...
			blinkTimer8.Interval = 350; // 890 миллисекунд
		...
		//{
		//	this.Hide();
		//	Galvan_Line_PAL_CuEl1819_Technolog tmd = new Galvan_Line_PAL_CuEl1819_Technolog();
		//	tmd.ShowDialog();
		//	this.Show();
		//}
		...
		//{
		//	this.Hide();
		//	Galvan_Line_PAL_CuEl2021_Technolog tmd = new Galvan_Line_PAL_CuEl2021_Technolog();
		//	tmd.ShowDialog();
		//	this.Show();
		//}
