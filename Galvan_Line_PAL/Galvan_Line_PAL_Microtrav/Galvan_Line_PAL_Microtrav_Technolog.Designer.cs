...
{
	partial class Galvan_Line_PAL_Microtrav_Technolog
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Galvan_Line_PAL_Microtrav_Technolog));
			...
			// 
			// Galvan_Line_PAL_Microtrav_Technolog
			// 
			...
			this.Name = "Galvan_Line_PAL_Microtrav_Technolog";
			this.Text = "Лаборатория Резонит";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.Galvan_Line_PAL_Microtrav_Technolog_Load);
