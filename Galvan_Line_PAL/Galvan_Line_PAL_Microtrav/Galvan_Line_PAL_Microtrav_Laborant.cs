...
{
	public partial class Galvan_Line_PAL_Microtrav_Laborant : Form
	{
		public Galvan_Line_PAL_Microtrav_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Gal_Line_2_Na2S2O8"].DefaultCellStyle.BackColor = Color.LightBlue;
		...
		private void Galvan_Line_PAL_Microtrav_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void UpdateRow()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Gal_Line_2_Na2S2O8 = dataGridView1.Rows[rowIndex].Cells["Gal_Line_2_Na2S2O8"].Value;
   ...
   SET [Gal_Line_2_Na2S2O8] = @Gal_Line_2_Na2S2O8, 
...
[Gal_Line_2_podtrav] = @Gal_Line_2_podtrav
	...
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					//
					command.Parameters.AddWithValue("@Gal_Line_2_Na2S2O8", Gal_Line_2_Na2S2O8);
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Gal_Line_2_Na2S2O8" && column.Name != "Gal_Line_2_Cu2" && column.Name != "Gal_Line_2_podtrav")
				{
		...
		private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Gal_Line_2_Na2S2O8 = dataGridView1.Rows[e.RowIndex].Cells["Gal_Line_2_Na2S2O8"].Value;
