...
{
	public partial class Galvan_Line_PAL_Laborant : Form
	{
		public Galvan_Line_PAL_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Gal_Line_2_Na2S2O8"].DefaultCellStyle.BackColor = Color.LightBlue; // Новый столбец
				...
				dataGridView1.Columns["Gal_Line_4_CuSO4"].DefaultCellStyle.BackColor = Color.LightBlue; // Новый столбец
				...
				dataGridView1.Columns["Gal_Line_5_CuSO4"].DefaultCellStyle.BackColor = Color.LightBlue; // Новый столбец
				dataGridView1.Columns["Gal_Line_6_H2SO4"].DefaultCellStyle.BackColor = Color.LightBlue; // Новый столбец
				dataGridView1.Columns["Gal_Line_6_NaCl"].DefaultCellStyle.BackColor = Color.LightBlue; // Новый столбец
				dataGridView1.Columns["Gal_Line_6_CuSO4"].DefaultCellStyle.BackColor = Color.LightBlue; // Новый столбец
				dataGridView1.Columns["Gal_Line_7_H2SO4"].DefaultCellStyle.BackColor = Color.LightBlue; // Новый столбец
				dataGridView1.Columns["Gal_Line_7_SnSO4"].DefaultCellStyle.BackColor = Color.LightBlue;
			}

		}


		private void Galvan_Line_PAL_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void Add_Row()
		{
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				string sqlInsert = "INSERT INTO Galvan_Line_PAL ([Date_Create],[FIO_Lab]) " +
		...
		private void UpdateRow()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Gal_Line_2_Na2S2O8 = dataGridView1.Rows[rowIndex].Cells["Gal_Line_2_Na2S2O8"].Value; // Изменено
				...
				var Gal_Line_4_CuSO4 = dataGridView1.Rows[rowIndex].Cells["Gal_Line_4_CuSO4"].Value; // Изменено
				...
				var Gal_Line_5_CuSO4 = dataGridView1.Rows[rowIndex].Cells["Gal_Line_5_CuSO4"].Value; // Изменено
				var Gal_Line_6_H2SO4 = dataGridView1.Rows[rowIndex].Cells["Gal_Line_6_H2SO4"].Value;
				var Gal_Line_6_NaCl = dataGridView1.Rows[rowIndex].Cells["Gal_Line_6_NaCl"].Value; // Новый столбец
				var Gal_Line_6_CuSO4 = dataGridView1.Rows[rowIndex].Cells["Gal_Line_6_CuSO4"].Value; // Новый столбец
				var Gal_Line_7_H2SO4 = dataGridView1.Rows[rowIndex].Cells["Gal_Line_7_H2SO4"].Value; // Новый столбец
				var Gal_Line_7_SnSO4 = dataGridView1.Rows[rowIndex].Cells["Gal_Line_7_SnSO4"].Value; // Новый столбец



				// Создаем команду обновления с несколькими столбцами
				string updateQuery = @"
            UPDATE Galvan_Line_PAL
   SET [Gal_Line_1_AC_22C] = @Gal_Line_1_AC_22C, 
[Gal_Line_1_Cu2] = @Gal_Line_1_Cu2, 
[Gal_Line_2_Na2S2O8] = @Gal_Line_2_Na2S2O8, 
...
[Gal_Line_6_NaCl] = @Gal_Line_6_NaCl, 
[Gal_Line_6_CuSO4] = @Gal_Line_6_CuSO4, 
[Gal_Line_7_H2SO4] = @Gal_Line_7_H2SO4, 
[Gal_Line_7_SnSO4] = @Gal_Line_7_SnSO4
	...
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					command.Parameters.AddWithValue("@Gal_Line_2_Na2S2O8", Gal_Line_2_Na2S2O8); // Изменено с NH4_2S2O8 на Na2S2O8
					...
					command.Parameters.AddWithValue("@Gal_Line_4_CuSO4", Gal_Line_4_CuSO4); // Изменено с PM624A и PM624b на CuSO4
					...
					command.Parameters.AddWithValue("@Gal_Line_5_CuSO4", Gal_Line_5_CuSO4); // Изменено с PM624A и PM624b на CuSO4
					command.Parameters.AddWithValue("@Gal_Line_6_H2SO4", Gal_Line_6_H2SO4);
					command.Parameters.AddWithValue("@Gal_Line_6_NaCl", Gal_Line_6_NaCl); // Изменено с SnSO4 на NaCl
					command.Parameters.AddWithValue("@Gal_Line_6_CuSO4", Gal_Line_6_CuSO4); // Изменено с SnSO4 на CuSO4
					command.Parameters.AddWithValue("@Gal_Line_7_H2SO4", Gal_Line_7_H2SO4); // Добавлено
					command.Parameters.AddWithValue("@Gal_Line_7_SnSO4", Gal_Line_7_SnSO4); // Добавлено
					//
		...
		private void NotClickOnTable()
		{
			foreach (DataGridViewColumn column in dataGridView1.Columns)
			{
				if (column.Name != "Gal_Line_1_AC_22C" && column.Name != "Gal_Line_1_Cu2" &&
				 column.Name != "Gal_Line_2_Na2S2O8" && column.Name != "Gal_Line_2_Cu2" &&
				 ...
				 column.Name != "Gal_Line_4_NaCl" && column.Name != "Gal_Line_4_CuSO4" &&
				 column.Name != "Gal_Line_5_H2SO4" && column.Name != "Gal_Line_5_NaCl" &&
				 column.Name != "Gal_Line_5_CuSO4" && column.Name != "Gal_Line_6_H2SO4" &&
				 column.Name != "Gal_Line_6_NaCl" && column.Name != "Gal_Line_6_CuSO4" &&
				 column.Name != "Gal_Line_7_H2SO4" && column.Name != "Gal_Line_7_SnSO4")
				{
		...
		private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Gal_Line_2_Na2S2O8 = dataGridView1.Rows[e.RowIndex].Cells["Gal_Line_2_Na2S2O8"].Value; // Изменено
				...
				var Gal_Line_4_CuSO4 = dataGridView1.Rows[e.RowIndex].Cells["Gal_Line_4_CuSO4"].Value; // Изменено
				...
				var Gal_Line_5_CuSO4 = dataGridView1.Rows[e.RowIndex].Cells["Gal_Line_5_CuSO4"].Value; // Изменено
				var Gal_Line_6_H2SO4 = dataGridView1.Rows[e.RowIndex].Cells["Gal_Line_6_H2SO4"].Value;
				var Gal_Line_6_NaCl = dataGridView1.Rows[e.RowIndex].Cells["Gal_Line_6_NaCl"].Value; // Новый столбец
				var Gal_Line_6_CuSO4 = dataGridView1.Rows[e.RowIndex].Cells["Gal_Line_6_CuSO4"].Value; // Новый столбец
				var Gal_Line_7_H2SO4 = dataGridView1.Rows[e.RowIndex].Cells["Gal_Line_7_H2SO4"].Value; // Новый столбец
				var Gal_Line_7_SnSO4 = dataGridView1.Rows[e.RowIndex].Cells["Gal_Line_7_SnSO4"].Value;
...
[Gal_Line_7_SnSO4] = @Gal_Line_7_SnSO4
	...
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					command.Parameters.AddWithValue("@Gal_Line_6_CuSO4", Gal_Line_6_CuSO4); // Изменено с SnSO4 на CuSO4
					command.Parameters.AddWithValue("@Gal_Line_7_H2SO4", Gal_Line_7_H2SO4); // Добавлено
					command.Parameters.AddWithValue("@Gal_Line_7_SnSO4", Gal_Line_7_SnSO4);
					//
					command.Parameters.AddWithValue("@ID", id); // ID - это первичный ключ
