...
{
	public partial class Galvan_Line_PAL_CuEl1920_Laborant : Form
	{
		public Galvan_Line_PAL_CuEl1920_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Line_PAL_CuEl1920_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
...
[Gal_Line_4_CuSO4] = @Gal_Line_4_CuSO4
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Gal_Line_4_H2SO4" && column.Name != "Gal_Line_4_NaCl" && column.Name != "Gal_Line_4_CuSO4")
				{
