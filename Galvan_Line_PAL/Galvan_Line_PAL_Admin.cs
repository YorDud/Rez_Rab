...
{
	public partial class Galvan_Line_PAL_Admin : Form
	{
		public Galvan_Line_PAL_Admin()
		{
			InitializeComponent();
		...
		private void LoadData()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				dataGridView1.Columns["Gal_Line_7_Correction"].HeaderText = "Корректировка"; // Новый столбец
																							 //
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Line_PAL_Admin_Load(object sender, EventArgs e)
		{
		...
		private void Add_Row()
		{
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				string sqlInsert = "INSERT INTO Galvan_Line_PAL ([Date_Create]) " +
								   "VALUES (@Date_Create)";
		...
		private void dataGridView1_CellEndEdit_1(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Gal_Line_7_SnSO4 = dataGridView1.Rows[e.RowIndex].Cells["Gal_Line_7_SnSO4"].Value; // Новый столбец
				var Gal_Line_7_Correction = dataGridView1.Rows[e.RowIndex].Cells["Gal_Line_7_Correction"].Value; // Новый столбец
...
var Сomment = dataGridView1.Rows[e.RowIndex].Cells["Сomment"].Value;
   ...
   SET [Date_Create] = @Date_Create
      ,[FIO_Lab] = @FIO_Lab
      ,[Gal_Line_1_AC_22C] = @Gal_Line_1_AC_22C, 
...
[Gal_Line_7_Correction] = @Gal_Line_7_Correction
      ,[FIO_tech] = @FIO_tech
,[Date_tech] = @Date_tech
...
,[Сomment] = @Сomment
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					command.Parameters.AddWithValue("@Gal_Line_7_Correction", Gal_Line_7_Correction); // Добавлено
					//
