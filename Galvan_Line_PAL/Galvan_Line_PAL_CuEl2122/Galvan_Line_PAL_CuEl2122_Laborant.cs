...
{
	public partial class Galvan_Line_PAL_CuEl2122_Laborant : Form
	{
		public Galvan_Line_PAL_CuEl2122_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Line_PAL_CuEl2122_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
...
[Gal_Line_5_CuSO4] = @Gal_Line_5_CuSO4
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Gal_Line_5_H2SO4" && column.Name != "Gal_Line_5_NaCl" && column.Name != "Gal_Line_5_CuSO4")
				{
