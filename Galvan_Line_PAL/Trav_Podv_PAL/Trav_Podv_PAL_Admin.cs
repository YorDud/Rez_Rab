...
namespace Rez_Lab.Trav_Podv_PAL
{
	public partial class Trav_Podv_PAL_Admin : Form
	{
		public Trav_Podv_PAL_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Trav_Podv_PAL_Admin_Load(object sender, EventArgs e)
		{
		...
		private void dataGridView1_CellEndEdit_1(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var FIO_Lab = dataGridView1.Rows[e.RowIndex].Cells["FIO_Lab"].Value; // Название столбца FIO_Lab
																					 //
				var Trav_Podv_PAL_HNO3 = dataGridView1.Rows[e.RowIndex].Cells["Trav_Podv_PAL_HNO3"].Value;
...
var Сomment = dataGridView1.Rows[e.RowIndex].Cells["Сomment"].Value;
   ...
   SET [Date_Create] = @Date_Create
      ,[FIO_Lab] = @FIO_Lab
      ,[Trav_Podv_PAL_HNO3] = @Trav_Podv_PAL_HNO3, 
...
,[Сomment] = @Сomment
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					//
					command.Parameters.AddWithValue("@Trav_Podv_PAL_HNO3", Trav_Podv_PAL_HNO3);
