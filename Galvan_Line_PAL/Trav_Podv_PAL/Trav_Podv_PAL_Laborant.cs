...
{
	public partial class Trav_Podv_PAL_Laborant : Form
	{
		public Trav_Podv_PAL_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Trav_Podv_PAL_HNO3"].DefaultCellStyle.BackColor = Color.LightBlue;
		...
		private void Trav_Podv_PAL_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void UpdateRow()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Trav_Podv_PAL_HNO3 = dataGridView1.Rows[rowIndex].Cells["Trav_Podv_PAL_HNO3"].Value;
   ...
   SET [Trav_Podv_PAL_HNO3] = @Trav_Podv_PAL_HNO3 
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Trav_Podv_PAL_HNO3")
				{
