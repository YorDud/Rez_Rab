...
{
	public partial class Galvan_Line_PAL_Sn_Laborant : Form
	{
		public Galvan_Line_PAL_Sn_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Line_PAL_Sn_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
   ...
   SET [Gal_Line_3_Sn_H2SO4] = @Gal_Line_3_Sn_H2SO4 
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Gal_Line_3_Sn_H2SO4")
				{
