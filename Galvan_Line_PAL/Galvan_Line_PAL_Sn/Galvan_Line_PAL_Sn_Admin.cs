...
namespace Rez_Lab.Galvan_Line_PAL_Sn
{
	public partial class Galvan_Line_PAL_Sn_Admin : Form
	{
		public Galvan_Line_PAL_Sn_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Line_PAL_Sn_Admin_Load(object sender, EventArgs e)
		{
