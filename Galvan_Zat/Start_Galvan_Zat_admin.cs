...
using Rez_Lab.Galvan_Zat_Cu;
using Rez_Lab.Galvan_Zat_CuEl12;
using Rez_Lab.Galvan_Zat_CuEl34;


namespace Rez_Lab
{
    public partial class Start_Galvan_Zat_Cleaner_admin : Form
    {

        
        public Start_Galvan_Zat_Cleaner_admin()
        {
            InitializeComponent();
        ...
        public Start_Galvan_Zat_Cleaner_admin(Avtorize aavtorize)
        {
            InitializeComponent();
        ...
        private void Start_Galvan_Zat_Cleaner_admin_Load(object sender, EventArgs e)
        {
		...
		{
			this.Hide();
			Galvan_Zat_CuEl12_Admin TM2A = new Galvan_Zat_CuEl12_Admin();
			TM2A.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Zat_CuEl34_Admin poa = new Galvan_Zat_CuEl34_Admin();
			poa.ShowDialog();
			this.Show();
		...
		{
			this.Hide();
			//Galvan_Zat_Sn_Admin poa = new Galvan_Zat_Sn_Admin();
			//poa.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			//Galvan_Zat_CuEl1920_Admin poa = new Galvan_Zat_CuEl1920_Admin();
			//poa.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			//Galvan_Zat_CuEl2122_Admin poa = new Galvan_Zat_CuEl2122_Admin();
			//poa.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			//Galvan_Zat_SnEl_Admin poa = new Galvan_Zat_SnEl_Admin();
			//poa.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Zat_Cu_Admin poa = new Galvan_Zat_Cu_Admin();
			poa.ShowDialog();
			this.Show();
		}
		...
		//{
		//	this.Hide();
		//	Galvan_Zat_KisOch_Admin poa = new Galvan_Zat_KisOch_Admin();
		//	poa.ShowDialog();
		//	this.Show();
		//}
		...
		//{
		//	this.Hide();
		//	Galvan_Zat_CuEl2324_Admin poa = new Galvan_Zat_CuEl2324_Admin();
		//	poa.ShowDialog();
		//	this.Show();
		//}
	}
