...
{
	public partial class Galvan_Zat_CuEl34_Laborant : Form
	{
		public Galvan_Zat_CuEl34_Laborant()
		{
			InitializeComponent();
		...
		private void LoadData()
		{
			...
			{
				connection.Open();
				dataAdapter = new SqlDataAdapter("SELECT * FROM Galvan_Zat_CuEl34 ORDER BY Date_Create DESC", connection);
				...
				dataGridView1.Columns["Gal_Zat_3_PM624Ast"].HeaderText = "ПМ 614БВ (подавитель)";
				dataGridView1.Columns["Gal_Zat_3_PM624A"].HeaderText = "ПМ 624А (блеск)";
				dataGridView1.Columns["Gal_Zat_3_CuSO4"].HeaderText = "CuSO4";
				dataGridView1.Columns["Gal_Line_Ah"].HeaderText = "Ah";
				dataGridView1.Columns["Gal_Zat_3_Correction_Mat"].HeaderText = "Корректировка Материал";
				dataGridView1.Columns["Gal_Zat_3_Correction_Score"].HeaderText = "Корректировка Количество";
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Gal_Zat_3_PM624Ast"].DefaultCellStyle.BackColor = Color.LightBlue;
				dataGridView1.Columns["Gal_Zat_3_PM624A"].DefaultCellStyle.BackColor = Color.LightBlue;
		...
		private void Galvan_Zat_CuEl34_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void LoadDataDateTimePicker(DateTime date)
		{
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				string query = "SELECT * FROM Galvan_Zat_CuEl34 WHERE CAST(Date_Create AS DATE) = @SelectedDate ORDER BY Date_Create DESC";
		...
		private void LoadDataByDateRange(DateTime startDate, DateTime endDate)
		{
			...
			{
				connection.Open();
				string query = "SELECT * FROM Galvan_Zat_CuEl34 WHERE CAST(Date_Create AS DATE) BETWEEN @StartDate AND @EndDate ORDER BY Date_Create DESC";
				using (SqlCommand command = new SqlCommand(query, connection))
				{
		...
		private void Add_Row()
		{
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				string sqlInsert = "INSERT INTO Galvan_Zat_CuEl34 ([Date_Create],[FIO_Lab]) " +
		...
		private void UpdateRow()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Gal_Zat_3_PM624Ast = dataGridView1.Rows[rowIndex].Cells["Gal_Zat_3_PM624Ast"].Value;
				var Gal_Zat_3_PM624A = dataGridView1.Rows[rowIndex].Cells["Gal_Zat_3_PM624A"].Value;
				...
				string updateQuery = @"
            UPDATE Galvan_Zat_CuEl34
   SET [Gal_Zat_3_H2SO4] = @Gal_Zat_3_H2SO4,
[Gal_Zat_3_NaCl] = @Gal_Zat_3_NaCl, 
[Gal_Zat_3_PM624Ast] = @Gal_Zat_3_PM624Ast, 
[Gal_Zat_3_PM624A] = @Gal_Zat_3_PM624A,
[Gal_Zat_3_CuSO4] = @Gal_Zat_3_CuSO4
	...
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					command.Parameters.AddWithValue("@Gal_Zat_3_PM624Ast", Gal_Zat_3_PM624Ast);
					command.Parameters.AddWithValue("@Gal_Zat_3_PM624A", Gal_Zat_3_PM624A);
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Gal_Zat_3_H2SO4" && column.Name != "Gal_Zat_3_NaCl" && column.Name != "Gal_Zat_3_PM624Ast" && column.Name != "Gal_Zat_3_PM624A" && column.Name != "Gal_Zat_3_CuSO4")
				{
		...
		private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Gal_Zat_3_PM624Ast = dataGridView1.Rows[e.RowIndex].Cells["Gal_Zat_3_PM624Ast"].Value;
				var Gal_Zat_3_PM624A = dataGridView1.Rows[e.RowIndex].Cells["Gal_Zat_3_PM624A"].Value;
...
[Gal_Zat_3_CuSO4] = @Gal_Zat_3_CuSO4
	...
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					command.Parameters.AddWithValue("@Date_Lab_Update", Date_Lab_Update);
					command.Parameters.AddWithValue("@FIO_Lab_Update", FIO_Lab_Update);
					command.Parameters.AddWithValue("@Gal_Zat_3_H2SO4", Gal_Zat_3_H2SO4 ?? DBNull.Value);
					command.Parameters.AddWithValue("@Gal_Zat_3_NaCl", Gal_Zat_3_NaCl ?? DBNull.Value);
					command.Parameters.AddWithValue("@Gal_Zat_3_PM624Ast", Gal_Zat_3_PM624Ast ?? DBNull.Value);
					command.Parameters.AddWithValue("@Gal_Zat_3_PM624A", Gal_Zat_3_PM624A ?? DBNull.Value);
					command.Parameters.AddWithValue("@Gal_Zat_3_CuSO4", Gal_Zat_3_CuSO4 ?? DBNull.Value);
					command.Parameters.AddWithValue("@ID", id); // ID - это первичный ключ
		...
		private void HighlightEmptyCells(DataGridView dataGridView, int[] columns)
		{
			...
			try
			{
				correctionMatColumnIndex = dataGridView.Columns["Gal_Zat_3_Correction_Mat"].Index;
			}
			catch (ArgumentException)
			{
				throw new ArgumentException("Столбец 'Gal_Zat_3_Correction_Mat' не найден в DataGridView.");
			}
		...
		private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			if (e.RowIndex >= 0 && columnsToCheck.Contains(e.ColumnIndex))
			{
				...
				var correctionMatValue = selectedRow.Cells["Gal_Zat_3_Correction_Mat"].Value;
				...
				if (idValue != null)
				{
					if (int.TryParse(idValue.ToString(), out int idClick))
					{
						...
						string query = @"UPDATE Galvan_Zat_CuEl34 SET 
                                 [Date_Corr] = @Date_Corr,
                                 [Сompleted] = @Сompleted,
                                 [FIO_Corr] = @FIO_Corr
                                 WHERE ID = @Id";
