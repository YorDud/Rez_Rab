...
{
	public partial class Galvan_Zat_CuEl34_Technolog : Form
	{
		public Galvan_Zat_CuEl34_Technolog()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Gal_Zat_3_Correction_Mat"].DefaultCellStyle.BackColor = Color.PeachPuff;
				dataGridView1.Columns["Gal_Zat_3_Correction_Score"].DefaultCellStyle.BackColor = Color.PeachPuff;
		...
		private void Galvan_Zat_CuEl34_Technolog_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Gal_Zat_3_Correction_Score" && column.Name != "Gal_Zat_3_Correction_Mat" && column.Name != "Сomment" && column.Name != "Gal_Line_Ah") // предполагается, что "ID" - это столбец, который можно редактировать
				{
		...
		private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Gal_Zat_3_Correction_Mat = dataGridView1.Rows[e.RowIndex].Cells["Gal_Zat_3_Correction_Mat"].Value;
				var Gal_Zat_3_Correction_Score = dataGridView1.Rows[e.RowIndex].Cells["Gal_Zat_3_Correction_Score"].Value;
				...
				string updateQuery = @"
        UPDATE Galvan_Zat_CuEl34 SET
            [Date_tech] = @Date_tech,
            [Gal_Zat_3_Correction_Mat] = @Gal_Zat_3_Correction_Mat
			,[Gal_Line_Ah] = @Gal_Line_Ah
			,[Gal_Zat_3_Correction_Score] = @Gal_Zat_3_Correction_Score
			,[Сomment] = @Comment
            ,FIO_tech = @FIO_tech
        WHERE ID = @Id";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					command.Parameters.AddWithValue("@Gal_Zat_3_Correction_Mat", Gal_Zat_3_Correction_Mat);
					command.Parameters.AddWithValue("@Gal_Zat_3_Correction_Score", Gal_Zat_3_Correction_Score);
		...
		private void UpdateRow()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Gal_Zat_3_Correction_Mat = dataGridView1.Rows[rowIndex].Cells["Gal_Zat_3_Correction_Mat"].Value;
				var Gal_Zat_3_Correction_Score = dataGridView1.Rows[rowIndex].Cells["Gal_Zat_3_Correction_Score"].Value;
				//var Comment = dataGridView1.Rows[e.RowIndex].Cells["Сomment"].Value;
   ...
   SET [Gal_Zat_3_Correction_Mat] = @Gal_Zat_3_Correction_Mat
			,[Gal_Line_Ah] = @Gal_Line_Ah
			,[Gal_Zat_3_Correction_Score] = @Gal_Zat_3_Correction_Score
