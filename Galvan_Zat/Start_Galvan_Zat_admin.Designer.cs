namespace Rez_Lab
{
    partial class Start_Galvan_Zat_Cleaner_admin
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Start_Galvan_Zat_Cleaner_admin));
			...
			this.button4.Text = "Cu электролит (ванна 1-2)";
			...
			this.button5.Text = "Cu электролит (ванна 3-4)";
			...
			// 
			// Start_Galvan_Zat_Cleaner_admin
			// 
			...
			this.Name = "Start_Galvan_Zat_Cleaner_admin";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Лаборатория Резонит";
			this.Load += new System.EventHandler(this.Start_Galvan_Zat_Cleaner_admin_Load);
