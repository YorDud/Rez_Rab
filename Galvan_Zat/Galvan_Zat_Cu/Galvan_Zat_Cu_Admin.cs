...
namespace Rez_Lab.Galvan_Zat_Cu
{
	public partial class Galvan_Zat_Cu_Admin : Form
	{
		public Galvan_Zat_Cu_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Zat_Cu_Admin_Load(object sender, EventArgs e)
		{
		...
		private void dataGridView1_CellEndEdit_1(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var FIO_Lab = dataGridView1.Rows[e.RowIndex].Cells["FIO_Lab"].Value; // Название столбца FIO_Lab
																					 //
				var Gal_Zat_1_Cu_H2SO4 = dataGridView1.Rows[e.RowIndex].Cells["Gal_Zat_1_Cu_H2SO4"].Value;
...
var Сomment = dataGridView1.Rows[e.RowIndex].Cells["Сomment"].Value;
   ...
   SET [Date_Create] = @Date_Create
      ,[FIO_Lab] = @FIO_Lab
      ,[Gal_Zat_1_Cu_H2SO4] = @Gal_Zat_1_Cu_H2SO4, 
...
,[Сomment] = @Сomment
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					//
					command.Parameters.AddWithValue("@Gal_Zat_1_Cu_H2SO4", Gal_Zat_1_Cu_H2SO4);
