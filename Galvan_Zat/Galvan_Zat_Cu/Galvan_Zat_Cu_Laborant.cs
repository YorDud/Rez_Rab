...
{
	public partial class Galvan_Zat_Cu_Laborant : Form
	{
		public Galvan_Zat_Cu_Laborant()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
				...
				dataGridView1.Columns["Gal_Zat_1_Cu_H2SO4"].DefaultCellStyle.BackColor = Color.LightBlue;
		...
		private void Galvan_Zat_Cu_Laborant_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void UpdateRow()
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Gal_Zat_1_Cu_H2SO4 = dataGridView1.Rows[rowIndex].Cells["Gal_Zat_1_Cu_H2SO4"].Value;
   ...
   SET [Gal_Zat_1_Cu_H2SO4] = @Gal_Zat_1_Cu_H2SO4 
	...
	WHERE ID = @ID";
		...
		private void NotClickOnTable()
		{
			...
			{
				if (column.Name != "Gal_Zat_1_Cu_H2SO4")
				{
   ...
   SET [Gal_Zat_1_Cu_H2SO4] = @Gal_Zat_1_Cu_H2SO4
	...
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					command.Parameters.AddWithValue("@Date_Lab_Update", Date_Lab_Update);
					command.Parameters.AddWithValue("@FIO_Lab_Update", FIO_Lab_Update);
					command.Parameters.AddWithValue("@Gal_Zat_1_Cu_H2SO4", Gal_Zat_1_Cu_H2SO4 ?? DBNull.Value);
					command.Parameters.AddWithValue("@ID", id); // ID - это первичный ключ
