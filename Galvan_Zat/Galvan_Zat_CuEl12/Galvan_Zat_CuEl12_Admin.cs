...
namespace Rez_Lab.Galvan_Zat_CuEl12
{
	public partial class Galvan_Zat_CuEl12_Admin : Form
	{
		public Galvan_Zat_CuEl12_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Galvan_Zat_CuEl12_Admin_Load(object sender, EventArgs e)
		{
