...
namespace Rez_Lab
{
    public partial class Start_Galvan_Zat_Cleaner_technolog : Form
    {
		private Timer timer;
		...
		public Start_Galvan_Zat_Cleaner_technolog()
        {
            InitializeComponent();
        ...
        private void Start_Galvan_Zat_Cleaner_technolog_Load(object sender, EventArgs e)
        {
            label1.Text = WC.fio;
...
//		}
		...
		{
			this.Hide();
			Galvan_Zat_Cu_Technolog tmd = new Galvan_Zat_Cu_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Zat_CuEl12_Technolog tmd = new Galvan_Zat_CuEl12_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Galvan_Zat_CuEl34_Technolog tmd = new Galvan_Zat_CuEl34_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
...
WHERE ([FIO_tech] IS NULL OR [FIO_tech] = '') 
   OR ([Date_tech] IS NULL OR [Date_tech] = '');";
		...
		//{
		//	this.Hide();
		//	Galvan_Zat_KisOch_Technolog tmd = new Galvan_Zat_KisOch_Technolog();
		//	tmd.ShowDialog();
		//	this.Show();
		//}
		...
		//{
		//	this.Hide();
		//	Galvan_Zat_Microtrav_Technolog tmd = new Galvan_Zat_Microtrav_Technolog();
		//	tmd.ShowDialog();
		//	this.Show();
		//}
		...
		//{
		//	this.Hide();
		//	Galvan_Zat_Sn_Technolog tmd = new Galvan_Zat_Sn_Technolog();
		//	tmd.ShowDialog();
		//	this.Show();
		//}
		...
		//{
		//	this.Hide();
		//	Galvan_Zat_CuEl1920_Technolog tmd = new Galvan_Zat_CuEl1920_Technolog();
		//	tmd.ShowDialog();
		//	this.Show();
		//}
		...
		//{
		//	this.Hide();
		//	Galvan_Zat_CuEl2122_Technolog tmd = new Galvan_Zat_CuEl2122_Technolog();
		//	tmd.ShowDialog();
		//	this.Show();
		//}
		...
		//{
		//	this.Hide();
		//	Galvan_Zat_CuEl2324_Technolog tmd = new Galvan_Zat_CuEl2324_Technolog();
		//	tmd.ShowDialog();
		//	this.Show();
		//}
		...
		//{
		//	this.Hide();
		//	Galvan_Zat_SnEl_Technolog tmd = new Galvan_Zat_SnEl_Technolog();
		//	tmd.ShowDialog();
		//	this.Show();
		//}
		...
		//{
		//	this.Hide();
		//	Galvan_Zat_CuEl1819_Technolog tmd = new Galvan_Zat_CuEl1819_Technolog();
		//	tmd.ShowDialog();
		//	this.Show();
		//}
		...
		//{
		//	this.Hide();
		//	Galvan_Zat_CuEl2021_Technolog tmd = new Galvan_Zat_CuEl2021_Technolog();
		//	tmd.ShowDialog();
		//	this.Show();
		//}
