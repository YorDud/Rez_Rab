...
{
	public partial class Per_Obr_Admin : Form
	{
		public Per_Obr_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Per_Obr_Admin_Load(object sender, EventArgs e)
		{
		...
		private void Add_Row()
		{
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				string sqlInsert = "INSERT INTO Per_Obr ([Date_Create]) " +
								   "VALUES (@Date_Create)";
