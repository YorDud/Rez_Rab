...
namespace Rez_Lab
{
	public partial class Start_Perm_Obra_correcter : Form
	{
		...
		public Start_Perm_Obra_correcter()
		{
			InitializeComponent();
			//TimerForButton();
			timer = new Timer();
		...
		private void Start_Perm_Obra_correcter_Load(object sender, EventArgs e)
		{
...
//		}
		...
		{
			this.Hide();
			Perm_Obra_RasOkis_Corrector tmc = new Perm_Obra_RasOkis_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Perm_Obra_Sens_Corrector tmc = new Perm_Obra_Sens_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Perm_Obra_PredNe_Corrector tmc = new Perm_Obra_PredNe_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Perm_Obra_PredNe2_Corrector tmc = new Perm_Obra_PredNe2_Corrector();
			tmc.ShowDialog();
			this.Show();
		}
		...
		private void Load_Processes()
		{
			...
			//Cleaner();
			Load_Perm_Obra_Sens();
			Load_Perm_Obra_PredNe();
			Load_Perm_Obra_PredNe2();
			Load_Perm_Obra_RasOkis();
		...
		private void Load_Perm_Obra_Sens()
		{
			string query = @"
         SELECT COUNT(*) 
FROM Perm_Obra_Sens
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Per_Obr_1_Correction_Mat] IS NOT NULL AND [Per_Obr_1_Correction_Mat] <> '') OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Per_Obr_1_Correction_Score] IS NOT NULL AND [Per_Obr_1_Correction_Score] <> ''));";
		...
		private void Load_Perm_Obra_RasOkis()
		{
			string query = @"
         SELECT COUNT(*) 
...
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Per_Obr_2_Correction_Mat] IS NOT NULL AND [Per_Obr_2_Correction_Mat] <> '') OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Per_Obr_2_Correction_Score] IS NOT NULL AND [Per_Obr_2_Correction_Score] <> ''));";
		...
		private void Load_Perm_Obra_PredNe()
		{
			string query = @"
         SELECT COUNT(*) 
...
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Per_Obr_3_Correction_Mat] IS NOT NULL AND [Per_Obr_3_Correction_Mat] <> '') OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Per_Obr_3_Correction_Score] IS NOT NULL AND [Per_Obr_3_Correction_Score] <> ''));";
		...
		private void Load_Perm_Obra_PredNe2()
		{
			string query = @"
         SELECT COUNT(*) 
...
WHERE ([Сompleted] IS NULL OR [Сompleted] = '') 
AND (
    ([Per_Obr_4_Correction_Mat] IS NOT NULL AND [Per_Obr_4_Correction_Mat] <> '') OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR 
    ([Per_Obr_4_Correction_Score] IS NOT NULL AND [Per_Obr_4_Correction_Score] <> ''));";
		...
		"!!! Сенсибилизация !!!",
		"!!! Раствор окисления !!!",
		"!!! Преднейтрализация 90л !!!",
		"!!! Преднейтрализация 180л !!!"
		};
		...
		private DataSet GetAllDataFromDatabase()
		{
			...
			string query = @"
            SELECT 
                [Per_Obr_1_Correction_Mat],
                [Per_Obr_1_Correction_Score],
                [Сomment]
            FROM 
                Perm_Obra_Sens
            WHERE 
                ...
                AND (
                    ...
                    OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR ([Per_Obr_1_Correction_Score] IS NOT NULL AND [Per_Obr_1_Correction_Score] <> '')
                );

            SELECT 
                [Per_Obr_2_Correction_Mat],
                [Per_Obr_2_Correction_Score],
                [Сomment]
            FROM 
                Perm_Obra_RasOkis
            WHERE 
                ...
                AND (
                    ...
                    OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR ([Per_Obr_2_Correction_Score] IS NOT NULL AND [Per_Obr_2_Correction_Score] <> '')
                );

            SELECT 
                [Per_Obr_3_Correction_Mat],
                [Per_Obr_3_Correction_Score],
                [Сomment]
            FROM 
                Perm_Obra_PredNe
            WHERE 
                ...
                AND (
                    ...
                    OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR ([Per_Obr_3_Correction_Score] IS NOT NULL AND [Per_Obr_3_Correction_Score] <> '')
                );
SELECT 
                [Per_Obr_4_Correction_Mat],
                [Per_Obr_4_Correction_Score],
                [Сomment]
            FROM 
                Perm_Obra_PredNe2
            WHERE 
                ...
                AND (
                    ...
                    OR ([Сomment] IS NOT NULL AND [Сomment] <> '') OR ([Per_Obr_4_Correction_Score] IS NOT NULL AND [Per_Obr_4_Correction_Score] <> '')
                );
        ";
		...
		private void PrintDocument_PrintPage(object sender, PrintPageEventArgs e)
		{
			...
			string title = "Перманганатная обработка";
