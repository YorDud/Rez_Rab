...
using Rez_Lab.Perm_Obra_RasOkis;
using Rez_Lab.Perm_Obra_Sens;
using Rez_Lab.Perm_Obra_PredNe;
using Rez_Lab.Perm_Obra_PredNe2;


namespace Rez_Lab
{
    public partial class Start_Perm_Obra_admin : Form
    {

        
        public Start_Perm_Obra_admin()
        {
            InitializeComponent();
        ...
        public Start_Perm_Obra_admin(Avtorize aavtorize)
        {
            InitializeComponent();
        ...
        private void Start_Perm_Obra_admin_Load(object sender, EventArgs e)
        {
		...
		{
			this.Hide();
			Perm_Obra_RasOkis_Admin TM2A = new Perm_Obra_RasOkis_Admin();
			TM2A.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Perm_Obra_PredNe_Admin poa = new Perm_Obra_PredNe_Admin();
			poa.ShowDialog();
			this.Show();
		...
		{
			this.Hide();
			Perm_Obra_Sens_Admin poa = new Perm_Obra_Sens_Admin();
			poa.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Perm_Obra_PredNe2_Admin poa = new Perm_Obra_PredNe2_Admin();
			poa.ShowDialog();
			this.Show();
		}
