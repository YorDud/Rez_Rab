...
namespace Rez_Lab
{
    public partial class Start_Perm_Obra_laborant : Form
    {
        public Start_Perm_Obra_laborant()
        {
            InitializeComponent();
		...
		{
			this.Hide();
			Perm_Obra_RasOkis_Laborant tmc = new Perm_Obra_RasOkis_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Perm_Obra_Sens_Laborant tmc = new Perm_Obra_Sens_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Perm_Obra_PredNe_Laborant tmc = new Perm_Obra_PredNe_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Perm_Obra_PredNe2_Laborant tmc = new Perm_Obra_PredNe2_Laborant();
			tmc.ShowDialog();
			this.Show();
		}
