...
{
	public partial class Perm_Obra_RasOkis_Admin : Form
	{
		public Perm_Obra_RasOkis_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Perm_Obra_RasOkis_Admin_Load(object sender, EventArgs e)
		{
		...
		private void dataGridView1_CellEndEdit_1(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Per_Obr_2_pokaz_avtiv = dataGridView1.Rows[e.RowIndex].Cells["Per_Obr_2_pokaz_avtiv"].Value;
