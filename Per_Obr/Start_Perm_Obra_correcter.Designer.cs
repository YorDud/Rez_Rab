namespace Rez_Lab
{
    partial class Start_Perm_Obra_correcter
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Start_Perm_Obra_correcter));
			...
			this.label2.Location = new System.Drawing.Point(723, 166);
			...
			this.button2.Text = "Нейтрализация";
			...
			this.button1.Text = "Сенсибилизация";
			...
			this.button5.Text = "Преднейтрализация";
			...
			this.button4.Text = "Раствор окисления";
			...
			this.Name = "Start_Perm_Obra_correcter";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Лаборатория Резонит";
			this.Load += new System.EventHandler(this.Start_Perm_Obra_correcter_Load);
