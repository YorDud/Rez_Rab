...
namespace Rez_Lab
{
    public partial class Start_Perm_Obra_technolog : Form
    {
		private Timer timer;
		...
		public Start_Perm_Obra_technolog()
        {
            InitializeComponent();
        ...
        private void Start_Perm_Obra_technolog_Load(object sender, EventArgs e)
        {
            label1.Text = WC.fio;
...
//		}
		...
		{
			this.Hide();
			Himich_Podgotov_Dek_Technolog tmd = new Himich_Podgotov_Dek_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Perm_Obra_RasOkis_Technolog tmd = new Perm_Obra_RasOkis_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Perm_Obra_Sens_Technolog tmd = new Perm_Obra_Sens_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Perm_Obra_PredNe_Technolog tmd = new Perm_Obra_PredNe_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Perm_Obra_PredNe2_Technolog tmd = new Perm_Obra_PredNe2_Technolog();
			tmd.ShowDialog();
			this.Show();
		}
