namespace Rez_Lab
{
    partial class Start_Himich_Podgotov_Cleaner_correcter
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Start_Himich_Podgotov_Cleaner_correcter));
			...
			this.label13.Text = "Химическая подготовка перед нанесением ЗПМ";
			...
			this.button1.Text = "Кислая очистка АС-23";
			...
			// 
			// Start_Himich_Podgotov_Cleaner_correcter
			// 
			...
			this.Name = "Start_Himich_Podgotov_Cleaner_correcter";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Лаборатория Резонит";
			this.Load += new System.EventHandler(this.Start_Himich_Podgotov_Cleaner_correcter_Load);
