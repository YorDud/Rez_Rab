...
namespace Rez_Lab
{
	public partial class Start_Himich_Podgotov_Cleaner_correcter : Form
	{
		...
		public Start_Himich_Podgotov_Cleaner_correcter()
		{
			InitializeComponent();
			//TimerForButton();
			timer = new Timer();
		...
		private void Start_Himich_Podgotov_Cleaner_correcter_Load(object sender, EventArgs e)
		{
...
//		}
		...
		private void Load_Processes()
		{
			//Load_Process1();
			//Cleaner();
			Load_Himich_Podgotov_KisOch();
			Load_Himich_Podgotov_Microtrav();
			Load_Himich_Podgotov_Dek();
		...
		private void Load_Himich_Podgotov_KisOch()
		{
			string query = @"
         SELECT COUNT(*) 
...
AND (
    ...
    ([Him_Podg_1_Correction_Score] IS NOT NULL AND [Him_Podg_1_Correction_Score] <> ''));";
		...
		private void Load_Himich_Podgotov_Microtrav()
		{
			string query = @"
         SELECT COUNT(*) 
...
AND (
    ...
    ([Him_Podg_2_Correction_Score] IS NOT NULL AND [Him_Podg_2_Correction_Score] <> ''));";
		...
		private void Load_Himich_Podgotov_Dek()
		{
			string query = @"
         SELECT COUNT(*) 
...
AND (
    ...
    ([Him_Podg_3_Correction_Score] IS NOT NULL AND [Him_Podg_3_Correction_Score] <> ''));";
		...
		private void PrintDocument_PrintPage(object sender, PrintPageEventArgs e)
		{
			...
			string title = "Химическая подготовка перед нанесением фотомаски";
