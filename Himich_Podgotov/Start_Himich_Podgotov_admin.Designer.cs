namespace Rez_Lab
{
    partial class Start_Himich_Podgotov_Cleaner_admin
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Start_Himich_Podgotov_Cleaner_admin));
			...
			// 
			// Start_Himich_Podgotov_Cleaner_admin
			// 
			...
			this.Name = "Start_Himich_Podgotov_Cleaner_admin";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Лаборатория Резонит";
			this.Load += new System.EventHandler(this.Start_Himich_Podgotov_Cleaner_admin_Load);
