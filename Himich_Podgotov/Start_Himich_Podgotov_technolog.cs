...
namespace Rez_Lab
{
    public partial class Start_Himich_Podgotov_Cleaner_technolog : Form
    {
		private Timer timer;
		...
		public Start_Himich_Podgotov_Cleaner_technolog()
        {
            InitializeComponent();
        ...
        private void Start_Himich_Podgotov_Cleaner_technolog_Load(object sender, EventArgs e)
        {
            label1.Text = WC.fio;
