namespace Rez_Lab
{
    partial class Start_Himich_Podgotov_Cleaner_technolog
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Start_Himich_Podgotov_Cleaner_technolog));
			...
			// 
			// Start_Himich_Podgotov_Cleaner_technolog
			// 
			...
			this.Name = "Start_Himich_Podgotov_Cleaner_technolog";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Лаборатория Резонит";
			this.Load += new System.EventHandler(this.Start_Himich_Podgotov_Cleaner_technolog_Load);
