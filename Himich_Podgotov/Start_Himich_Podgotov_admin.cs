...
namespace Rez_Lab
{
    public partial class Start_Himich_Podgotov_Cleaner_admin : Form
    {

        
        public Start_Himich_Podgotov_Cleaner_admin()
        {
            InitializeComponent();
        ...
        public Start_Himich_Podgotov_Cleaner_admin(Avtorize aavtorize)
        {
            InitializeComponent();
        ...
        private void Start_Himich_Podgotov_Cleaner_admin_Load(object sender, EventArgs e)
        {
		...
		{
			this.Hide();
			Himich_Podgotov_Microtrav_Admin TM2A = new Himich_Podgotov_Microtrav_Admin();
			TM2A.ShowDialog();
			this.Show();
		}
		...
		{
			this.Hide();
			Himich_Podgotov_Dek_Admin poa = new Himich_Podgotov_Dek_Admin();
			poa.ShowDialog();
			this.Show();
