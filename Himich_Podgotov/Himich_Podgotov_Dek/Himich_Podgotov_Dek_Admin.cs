...
{
	public partial class Himich_Podgotov_Dek_Admin : Form
	{
		public Himich_Podgotov_Dek_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Himich_Podgotov_Dek_Admin_Load(object sender, EventArgs e)
		{
...
var Сomment = dataGridView1.Rows[e.RowIndex].Cells["Сomment"].Value;
   ...
   SET [Date_Create] = @Date_Create
      ,[FIO_Lab] = @FIO_Lab
      ,[Him_Podg_3_plot] = @Him_Podg_3_plot, 
