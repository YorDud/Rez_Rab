...
{
	public partial class Himich_Podgotov_KisOch_Technolog : Form
	{
		public Himich_Podgotov_KisOch_Technolog()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Himich_Podgotov_KisOch_Technolog_Load(object sender, EventArgs e)
		{
			LoadData();
		...
		private void dataGridView1_CellEndEdit(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				string updateQuery = @"
        UPDATE Himich_Podgotov_KisOch SET
            [Date_tech] = @Date_tech,
