...
{
	public partial class Himich_Podgotov_KisOch_Admin : Form
	{
		public Himich_Podgotov_KisOch_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Himich_Podgotov_KisOch_Admin_Load(object sender, EventArgs e)
		{
