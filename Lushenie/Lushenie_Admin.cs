...
{
	public partial class Lushenie_Admin : Form
	{
		public Lushenie_Admin()
		{
			InitializeComponent();
...
dataGridView1.Columns["Сomment"].HeaderText = "Комментарий";
		...
		private void Lushenie_Admin_Load(object sender, EventArgs e)
		{
		...
		private void dataGridView1_CellEndEdit_1(object sender, DataGridViewCellEventArgs e)
		{
			...
			using (SqlConnection connection = new SqlConnection(WC.ConnectionString))
			{
				...
				var Lushen_Correction_Mat = dataGridView1.Rows[e.RowIndex].Cells["Lushen_Correction_Mat"].Value;
				var Lushen_Correction_Score = dataGridView1.Rows[e.RowIndex].Cells["Lushen_Correction_Score"].Value;
...
var Сomment = dataGridView1.Rows[e.RowIndex].Cells["Сomment"].Value;
   ...
   SET [Date_Create] = @Date_Create
      ,[FIO_Lab] = @FIO_Lab
      ,[Lushen_Na2S2O3] = @Lushen_Na2S2O3,
[Lushen_Cu2] = @Lushen_Cu2,
[Lushen_podtrav] = @Lushen_podtrav,
[Lushen_Correction_Mat] = @Lushen_Correction_Mat,
[Lushen_Correction_Score] = @Lushen_Correction_Score
      ,[FIO_tech] = @FIO_tech
,[Date_tech] = @Date_tech
...
,[Сomment] = @Сomment
	WHERE ID = @ID";
				...
				using (SqlCommand command = new SqlCommand(updateQuery, connection))
				{
					...
					command.Parameters.AddWithValue("@Lushen_Correction_Mat", Lushen_Correction_Mat);
					command.Parameters.AddWithValue("@Lushen_Correction_Score", Lushen_Correction_Score);
